...
export default function DesktopHomePage() {
  ...
  // GLOBAL vertical lift for all items
  const LIFT_Y = -90
  ...
  return (
    <div className="min-h-screen bg-[#f1f0ee] relative overflow-hidden scale-[1.15] origin-center pt-25">
      ...
      <div className="flex flex-col items-center justify-center w-full h-full pointer-events-none">
        ...
        >
          <h1
            className={`${playfair.className} text-6xl md:text-7xl tracking-wide text-[#5f6a61] mb-1 leading-tight`}
          >
            ANA FER DLT
          </h1>
        ...
        {!itemsVisible && (
          <motion.p
            ...
            className="text-center text-[#5f6a61] font-sans mt-16 text-2xl pointer-events-auto"
          >
